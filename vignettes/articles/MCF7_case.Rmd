...
```{r fragment-histone-processing, eval = FALSE}
data(MCF7_histones)
histone_frag_raw <- tidyr::drop_na(MCF7_histones)
...
```{r histone-import-mean, eval = TRUE}
data(MCF7_histones)
...
### 3.1.1. Fragments
```{r fragment-histone-processing2, eval = FALSE}
...
ggvenn(list(
  ...
  show_percentage = FALSE, text_size = 5) + ggtitle("Figure 6a: Venn diagram") + theme(
