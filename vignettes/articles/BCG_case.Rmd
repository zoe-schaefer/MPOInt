...
The `volcano_epi()` function plots the epiproteome data, assuming that all values have already been transformed and statistical analysis has already been performed.
