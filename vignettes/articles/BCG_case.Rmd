...
volcano_epi(df = THP1_single, fc_col = "log2(FC)",
            p_col = "P value", label_col = "PTM") +
  labs(title = "Volcano plot", x = "log2(FC)", y = "-log10(P-value)")
```
...
BlCa_intersections <- BlCa_intersections %>%
  add_row("Intersection" = "Bladder cancer/Phospho",
          "Hits" = paste(sort(intersect(GDA_BlCa$gene_symbol, phospho_FC$SYMBOL2)),
                         collapse = ", ")) %>% 
  add_row("Intersection" = "Bladder cancer/Total",
          "Hits" = paste(sort(intersect(GDA_BlCa$gene_symbol, total_FC$SYMBOL2)),
                         collapse = ", ")) %>% 
  add_row("Intersection" = "Total/Phospho",
          "Hits" = paste(sort(intersect(total_FC$SYMBOL2, phospho_FC$SYMBOL2)),
                         collapse = ", ")) %>% 
  add_row("Intersection" = "Bladder cancer/Phospho/Total",
          "Hits" = paste(sort(intersect(intersect(
            GDA_BlCa$gene_symbol, phospho_FC$SYMBOL2),
            total_FC$SYMBOL2)), collapse = ", "))
...
melanoma_intersections <- melanoma_intersections %>%
  ...
  add_row("Intersection" = "Melanoma/Phospho/Total",
          "Hits" = paste(sort(intersect(intersect(
            GDA_melanoma$gene_symbol, phospho_FC$SYMBOL2),
            total_FC$SYMBOL2)), collapse = ", "))
...
RSV_intersections <- RSV_intersections %>%
  add_row("Intersection" = "RSV/Phospho",
          "Hits" = paste(sort(intersect(GDA_RSV$gene_symbol, phospho_FC$SYMBOL2)),
                         collapse = ", ")) %>% 
  add_row("Intersection" = "RSV/Total",
          "Hits" = paste(sort(intersect(GDA_RSV$gene_symbol, total_FC$SYMBOL2)),
                         collapse = ", ")) %>% 
  add_row("Intersection" = "Total/Phospho",
          "Hits" = paste(sort(intersect(total_FC$SYMBOL2, phospho_FC$SYMBOL2)),
                         collapse = ", ")) %>% 
  add_row("Intersection" = "RSV/Phospho/Total",
          "Hits" = paste(sort(intersect(intersect(
            GDA_RSV$gene_symbol, phospho_FC$SYMBOL2),
            total_FC$SYMBOL2)), collapse = ", "))
...
# Filter by that list
total_histone_int <- filter(histone_single, grepl(targets, PTM))
