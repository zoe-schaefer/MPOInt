...
#' @param groups A list of named lists where each list is a group of peptides, labeled with the group name.
#' @param ... Optional.
#'
...
#' @examples
#' \dontrun{
#' volcano_groups(df = THP1_total, fc_col = "log2(FC)", p_col = "P value", label_col = "SYMBOL2") + ggtitle("Grouped volcano plot") + xlab("log2FC") + ylab("-log10P")
#' }
